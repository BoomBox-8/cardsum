      ...
      Center(
        child: GestureDetector(
          ...
          child: AnimatedSwitcher(
            ...
            child: _isFront
                ? const FlashcardFront(key: ValueKey(1))
                : const FlashcardBack(key: ValueKey(2)),
...
class FlashcardFront extends StatelessWidget {
  const FlashcardFront({super.key});
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            Text(
                'Generated By ourProjectLink.com',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            ,
              ...
              Text(
                '''Lorem Ipsum. Pretend there is some text here!
Pipelines are great at speeding up processing!
                
Pipeline stalls are like super bad! Who knew? How to prevent them?
 Do XYZ, YYZ, ZZX!''',
